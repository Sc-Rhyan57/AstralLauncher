...
fun AstralTopBar(title: String, actions: @Composable RowScope.() -> Unit = {}) {
    ...
    Column {
        Row(
            ...
            Box(
                modifier = Modifier.size(32.dp).clip(CircleShape).background(AL.GoldBg),
...
fun GoldButton(
    ...
    Button(
        ...
        colors = ButtonDefaults.buttonColors(
            ...
            disabledContainerColor = AL.GoldDark.copy(0.3f),
...
fun PurpleButton(
    ...
    Button(
        ...
        shape = RoundedCornerShape(14.dp),
        colors = ButtonDefaults.buttonColors(
            containerColor = AL.Purple,
            disabledContainerColor = AL.Purple.copy(0.3f)
        )
    ) {
        icon?.let { Icon(it, null, modifier = Modifier.size(18.dp)); Spacer(Modifier.width(8.dp)) }
        Text(text, fontWeight = FontWeight.Bold, fontSize = 14.sp)
...
fun EmptyState(
    ...
    Column(
        ...
        Box(
            modifier = Modifier.size(76.dp).clip(RoundedCornerShape(20.dp)).background(AL.GoldBg),
            contentAlignment = Alignment.Center
        ) {
